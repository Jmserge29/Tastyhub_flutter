          ...
          child: Column(
            ...
            children: [
              ...
              _buildPolicyItem(
                ...
                text: 'Eres responsable del contenido que publiques (recetas, imágenes, comentarios).',
              ),
              ...
              _buildPolicyItem(
                icon: Icons.front_hand_outlined,
                iconColor: const Color(0xFF8B1538),
                text: 'Evita subir material ofensivo, violento o que infrinja derechos de autor.',
              ),
              ...
              _buildPolicyItem(
                icon: Icons.front_hand_outlined,
                iconColor: const Color(0xFF8B1538),
                text: 'Las recetas e imágenes compartidas deben ser de tu autoría o contar con los permisos necesarios.',
              ),
              ...
              _buildPolicyItem(
                ...
                iconColor: const Color(0xFF8B1538),
                text: 'Respetamos tu información personal y solo será utilizada para mejorar tu experiencia dentro de la app.',
              ),
              ...
              _buildPolicyItem(
                icon: Icons.info_outline,
                iconColor: const Color(0xFF8B1538),
                text: 'Nunca compartiremos tus datos con terceros sin tu consentimiento.',
              ),
              ...
              _buildPolicyItem(
                icon: Icons.info_outline,
                iconColor: const Color(0xFF8B1538),
                text: 'Recuerda no publicar información sensible en tu perfil o recetas.',
              ),
